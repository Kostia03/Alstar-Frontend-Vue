<template>
    ...
    <div class="editor" v-show="!loading">
        ...
        <div class="pages-menu" v-if="pages.length > 1">
            <el-button :plain="index !== activePage" v-for="(page, index) in pages" :key="index"  :type="index === activePage ? 'primary' : ''" v-on:click="setPage(index)">
                {{page.name || index}}
            </el-button>
        </div>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                hostUrl: 'https://editor.alstar.ch', //'http://localhost:3000',
                language: {
                    cancelBtn: 'Cancel',
                    previewBtn: 'Preview',
                    saveBtn: 'Save',
